...
import static org.usfirst.frc.team5822.robot.Robot.*;
    ...
    synchronized protected void collect() {
        ...
        if (_piListener!=null) {
            ...
            if (piAddress!=null) {
                ...
                //this line was commented out but I put it back in because I want to see if/when it is sending data
        ...
        public void run() {
            ...
            try {
                ...
                while (true) {
                    ...
                    //added this line back in to see if it's actually getting packets
                    ...
                    if (receivePacket == null) {
                        ...
                        //I added this line because I want to make sure I am actually receiving stuff from the pi 
